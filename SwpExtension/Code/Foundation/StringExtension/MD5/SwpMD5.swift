...
fileprivate class SwpMD5Utils: NSObject {
    
    fileprivate static func SwpMD5UtilsRotateLeft(_ value: UInt32, bits: UInt32) -> UInt32 {
        return ((value << bits) & 0xFFFFFFFF) | (value >> (32 - bits))
    }
    
    fileprivate static func SwpMD5ToUInt32Array(_ slice: ArraySlice<UInt8>) -> Array<UInt32> {
...
class MD5: SwpMD5Protocol {
    ...
    public func calculate() -> [UInt8] {
        ...
        for chunk in BytesSequence(chunkSize: chunkSizeBytes, data: tmpMessage) {
            ...
            var M = SwpMD5Utils.SwpMD5ToUInt32Array(chunk)
            ...
            for j in 0 ..< sines.count {
                ...
                D = C
                C = B
                B = B &+ SwpMD5Utils.SwpMD5UtilsRotateLeft((A &+ F &+ sines[j] &+ M[g]), bits: shifts[j])
                A = dTemp
            }
